...
export default function Main() {
    ...
    const [isPaused, { toggle, set: setIsPaused }] = useToggle(true);
    ...
    useGSAP(
        () => {
            ...
            // gsap.to(animaton, { timeScale: 8, delay: 1.5 });
        },
        {
            scope: container,
        }
    ...
    return (
        <div ref={container}>
            ...
            >
                ...
                <text x="800" y="190" fontSize="12" fill="#333">
                    途经点
                </text>
                <circle
                    cx="800"
